...
const theme = ref<CheckboxPassThroughOptions>({
  ...
  box: `flex justify-center items-center rounded-sm w-5 h-5
        ...
        p-disabled:bg-surface-200 dark:p-disabled:bg-surface-700 
        p-disabled:border-surface-300 dark:p-disabled:border-surface-500 p-disabled:text-surface-500 dark:p-disabled:text-surface-400
